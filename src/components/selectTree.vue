      ...
      <el-select-menu
        ...
        <el-scrollbar
          ...
          <el-tree :data="treeData" ref="tree"
                   ...
                   @node-click="handconstreeNodeClick">
          </el-tree>
        </el-scrollbar>
      </el-select-menu>
    </transition>
...
<script type="text/babel">
  ...
  export default {
    ...
    methods: {
      ...
      handconstreeNodeClick(nodeData) {
